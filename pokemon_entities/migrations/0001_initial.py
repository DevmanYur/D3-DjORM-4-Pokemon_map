# Generated by Django 3.1.14 on 2023-10-25 15:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previous_evolution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pokemon_entities.pokemon', verbose_name='Из кого эволюционировал')),
            ],
        ),
        migrations.CreateModel(
            name='PokemonEntity',
            fields=[
                ...
                ('pokemon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pokemons_pokemonentity', to='pokemon_entities.pokemon', verbose_name='Покемон')),
            ],
        ),
    ]
