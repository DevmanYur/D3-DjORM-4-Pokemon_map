...
class Pokemon(models.Model):
    ...
    previous_evolution = models.ForeignKey("Pokemon",verbose_name="Из кого эволюционировал",on_delete=models.CASCADE, null=True, blank=True)
...
class PokemonEntity(models.Model):
    pokemon = models.ForeignKey(Pokemon, verbose_name='Покемон', on_delete=models.CASCADE, related_name="pokemons_pokemonentity")
